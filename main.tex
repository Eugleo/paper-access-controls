...
Nevertheless, some harmful applications might not decompose so neatly; we discuss this in \cref{section:feasibility-and-limitations}.

This approach leverages existing domain expertise while providing a concrete methodology to adapt it to knowledge access control.
...
The cost is negligible for the model provider, as most users will stay unverified (see \cref{section:feasibility-and-limitations}).
