...
\begin{abstract}
  ...
  While only a high-level proposal, our work takes the first step toward enabling more nuanced safety decisions: by giving model providers better tools for managing dual-use content, users could access more capabilities without sacrificing safety, and regulators would have options for more targeted policies.
\end{abstract}
